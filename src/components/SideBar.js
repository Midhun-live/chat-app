...
function Sidebar() {
  ...
  const [name, setName] = useState(""); // console.log("Conversations of Sidebar : ", conversations);
  ...
  useEffect(() => {
    ...
    axios.get("https://chat-app-server-three-xi.vercel.app/chat/", config).then((response) => {
  ...
  return (
    <div className="sidebar-con">
      ...
      <div className={"sb-search " + (lightTheme && "dark")}>
        ...
        <input
          placeholder="Search"
          className={"search-ip " + (lightTheme && "dark")}
        />
      </div>
          ...
          if (conversation.latestMessage === undefined) {
            ...
            return (
              ...
              >
                <div
                  key={index}
                  className={"convo-con " + (lightTheme && "dark")}
                  onClick={() => {
                    navigate(
                      "chat/" +
                        conversation._id +
            ...
            return (
              <div
                ...
                onClick={() => {
                  navigate(
                    "chat/" + conversation._id + "&" + oppositeUser.name
                  );
                }}
              >
                <p className={"con-icon " + (lightTheme && "dark")}>
